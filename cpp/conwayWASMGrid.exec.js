...
__ATINIT__.push();
memoryInitializer = "conwayWASMGrid.exec.js.mem";
...
var real__setWidth = asm["_setWidth"];
asm["_setWidth"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__setWidth.apply(null, arguments);
});
var real__setHeight = asm["_setHeight"];
asm["_setHeight"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__setHeight.apply(null, arguments);
});
...
var real__setPopulateChance = asm["_setPopulateChance"];
asm["_setPopulateChance"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__setPopulateChance.apply(null, arguments);
});
var real__updateGridState = asm["_updateGridState"];
asm["_updateGridState"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__updateGridState.apply(null, arguments);
});
var real__tester = asm["_tester"];
asm["_tester"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__tester.apply(null, arguments);
});
...
var real__initRandomGrid = asm["_initRandomGrid"];
asm["_initRandomGrid"] = (function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return real__initRandomGrid.apply(null, arguments);
});
...
var _setWidth = Module["_setWidth"] = asm["_setWidth"];
var _setHeight = Module["_setHeight"] = asm["_setHeight"];
var _put_in_buff = Module["_put_in_buff"] = asm["_put_in_buff"];
var _setPopulateChance = Module["_setPopulateChance"] = asm["_setPopulateChance"];
var _updateGridState = Module["_updateGridState"] = asm["_updateGridState"];
var _tester = Module["_tester"] = asm["_tester"];
var _memset = Module["_memset"] = asm["_memset"];
var _malloc = Module["_malloc"] = asm["_malloc"];
var _i64Add = Module["_i64Add"] = asm["_i64Add"];
var _memcpy = Module["_memcpy"] = asm["_memcpy"];
var _bitshift64Lshr = Module["_bitshift64Lshr"] = asm["_bitshift64Lshr"];
var _initRandomGrid = Module["_initRandomGrid"] = asm["_initRandomGrid"];
...
loadWebAssembly("conwayWASMGrid.exec.wasm", 'load-wasm-worker.js').then(function(unwasmed) {
